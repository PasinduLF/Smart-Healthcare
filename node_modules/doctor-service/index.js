...
// Get doctor profile by ID (used by frontend and notification-service)
...
// Update doctor profile (name, specialty, experience, availability, phone, maxPatients)
app.put('/profile/:id', async (req, res) => {
    try {
        const { name, specialty, specialization, experience, availability, phone, maxPatients } = req.body;
        ...
        if (specialization !== undefined && specialty === undefined) updates.specialty = specialization;
        if (experience !== undefined) updates.experience = Number(experience);
        if (availability !== undefined) updates.availability = availability;
        if (phone !== undefined) updates.phone = phone;
        if (maxPatients !== undefined) updates.maxPatients = Number(maxPatients);
