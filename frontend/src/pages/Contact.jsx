    ...
    return (
        <div className="pt-20 pb-20">
            ...
            <section className="container mx-auto px-6 text-center max-w-4xl mb-24">
                <h1 className="text-5xl font-black text-slate-900 mb-6 underline decoration-teal-200 underline-offset-8">Get in Touch.</h1>
            ...
            <section className="container mx-auto px-6 grid lg:grid-cols-3 gap-8 mb-32">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="p-8 bg-white border border-slate-100 rounded-[2.5rem] shadow-sm hover:shadow-xl transition-all">
                        ...
                        <p className="mt-4 font-bold text-indigo-600 text-sm">hello@smarthealth.com</p>
                    </div>
                    <div className="p-8 bg-indigo-600 rounded-[2.5rem] shadow-lg text-white">
                ...
                <div className="lg:col-span-2 p-10 bg-white border border-slate-100 rounded-[3rem] shadow-sm">
                    ...
                    <form className="grid md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            <input type="text" placeholder="John Doe" className="w-full px-5 py-4 bg-slate-50 border border-transparent focus:border-indigo-500 rounded-2xl outline-none transition-all" />
                        </div>
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-slate-400 uppercase tracking-widest px-1">Email Address</label>
                            <input type="email" placeholder="john@example.com" className="w-full px-5 py-4 bg-slate-50 border border-transparent focus:border-indigo-500 rounded-2xl outline-none transition-all" />
                        </div>
                        <div className="space-y-2 md:col-span-2">
                            <label className="text-xs font-bold text-slate-400 uppercase tracking-widest px-1">Subject</label>
                            <select className="w-full px-5 py-4 bg-slate-50 border border-transparent focus:border-indigo-500 rounded-2xl outline-none transition-all appearance-none">
                        ...
                        <div className="space-y-2 md:col-span-2">
                            ...
                            <textarea rows="5" placeholder="How can we help you?" className="w-full px-5 py-4 bg-slate-50 border border-transparent focus:border-indigo-500 rounded-2xl outline-none transition-all resize-none"></textarea>
                        </div>
                        <div className="md:col-span-2 pt-4">
                            <button className="w-full py-5 bg-indigo-600 text-white font-bold rounded-2xl hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-100 flex items-center justify-center gap-3">
                                Send Message
