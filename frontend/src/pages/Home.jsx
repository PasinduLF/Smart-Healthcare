    ...
    return (
        <div className="pb-20">
            ...
            <section className="relative pt-20 pb-20 md:pt-32 md:pb-32 overflow-hidden">
                <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 w-[600px] h-[600px] bg-navy-100/40 rounded-full blur-3xl animate-drift"></div>
                <div className="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/4 w-[500px] h-[500px] bg-brand-100/30 rounded-full blur-3xl animate-drift"></div>

                <div className="container mx-auto px-6 relative z-10 text-center max-w-5xl">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-50 border border-brand-100 text-navy-600 text-xs font-bold uppercase tracking-widest mb-8 animate-in fade-in slide-in-from-bottom-2">
                        <Star className="w-3 h-3 fill-current" />
                        Next-Gen Health Platform
                    </div>
                    <h1 className="text-5xl md:text-7xl font-black text-navy-600 leading-[1.1] mb-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        Smart Healthcare for a <span className="text-transparent bg-clip-text bg-gradient-to-r from-navy-600 to-brand-500">Smarter Future.</span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4 animate-in fade-in slide-in-from-bottom-8 duration-1000">
                        <Link to="/register" className="px-8 py-4 bg-navy-600 text-white font-bold rounded-2xl hover:bg-navy-700 transition-all shadow-xl shadow-navy-200 hover:-translate-y-1 flex items-center justify-center gap-2 group">
                            Get Started Now
            ...
            <section className="container mx-auto px-6 mb-32">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 p-10 bg-navy-600 rounded-[3rem] shadow-2xl relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_30%_20%,rgba(0,210,211,0.15),transparent)]"></div>
                    {stats.map((stat, i) => (
            ...
            <section className="container mx-auto px-6 mb-32">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    <h2 className="text-3xl md:text-5xl font-black text-navy-600 mb-6">Built for Reliability, Focused on You.</h2>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {features.map((f, i) => (
                        <div key={i} className="p-8 bg-white border border-slate-100 rounded-[2.5rem] hover:shadow-2xl hover:border-brand-100 transition-all duration-500 group hover:-translate-y-2">
                            <div className={`p-4 rounded-2xl inline-block mb-6 ${f.color} group-hover:scale-110 transition-transform duration-500`}>
                                <f.icon className="w-8 h-8" />
                            </div>
                            <h3 className="text-xl font-bold text-navy-600 mb-3">{f.title}</h3>
            ...
            <section className="container mx-auto px-6 mb-20">
                <div className="p-10 md:p-20 bg-gradient-to-br from-navy-600 to-navy-700 rounded-[3rem] shadow-2xl relative overflow-hidden flex flex-col lg:flex-row items-center gap-12 group">
                    ...
                    <div className="flex-1 text-center lg:text-left relative z-10">
                        ...
                        <Link to="/patient/ai" className="px-10 py-5 bg-white text-navy-600 font-bold rounded-2xl hover:shadow-2xl hover:scale-105 transition-all text-lg shadow-xl shadow-navy-900/20 inline-block">
                            Start Symptom Check
                        </Link>
                    </div>
            ...
            <section className="container mx-auto px-6 pb-20">
                <div className="grid md:grid-cols-3 gap-8">
                    {[
                        ...
                        <div key={i} className="p-8 bg-slate-50 rounded-3xl border border-transparent hover:border-brand-100 hover:bg-white transition-all">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h4 className="font-bold text-navy-600 text-sm">{t.name}</h4>
