    ...
    return (
        <div className="pt-20 pb-20">
            ...
            <section className="container mx-auto px-6 text-center max-w-4xl mb-24">
                <h1 className="text-5xl font-black text-navy-600 mb-6">Changing the Way You Experience <span className="text-brand-500">Health.</span></h1>
            ...
            <section className="container mx-auto px-6 grid md:grid-cols-2 gap-12 mb-32">
                <div className="p-10 bg-navy-600 rounded-[3rem] text-white space-y-6 flex flex-col justify-center">
                ...
                <div className="p-10 bg-navy-700 rounded-[3rem] text-white space-y-6 flex flex-col justify-center">
            ...
            <section className="container mx-auto px-6 mb-32 text-center">
                <h2 className="text-3xl md:text-5xl font-black text-navy-600 mb-16">The Values Driving Us</h2>
                <div className="grid md:grid-cols-3 gap-8">
                    {[
                        ...
                        <div key={i} className="p-8 bg-white border border-slate-100 rounded-3xl hover:border-brand-100 hover:shadow-xl transition-all group">
                            <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-brand-50 transition-colors">
                                <v.icon className="w-8 h-8 text-brand-600" />
                            </div>
