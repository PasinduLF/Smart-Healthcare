            ...
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
                    ...
                    <div className="space-y-6">
                        <Link to="/" className="flex items-center gap-2 group">
                            ...
                            <span className="text-xl font-black tracking-tighter text-white">
                                Smart<span className="text-indigo-400">Health</span>
                            </span>
                        </Link>
                        ...
                        <div className="flex gap-4">
                            {[Twitter, Linkedin, Instagram, Github].map((Icon, i) => (
                                <a key={i} href="#" className="p-2 bg-slate-800 hover:bg-indigo-600 text-slate-300 hover:text-white rounded-lg transition-all">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            <li><Link to="/contact" className="hover:text-indigo-400 transition">Contact Center</Link></li>
                ...
                <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-semibold uppercase tracking-widest">
                    <p>© {currentYear} SmartHealth Platform. All Rights Reserved.</p>
